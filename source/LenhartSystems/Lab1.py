    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            bounds=np.array([        # no bounds here
                [np.nan, np.nan],
                [np.nan, np.nan],  # Control bounds
            ]),
            terminal_cost=False,
        )

    def dynamics(self, x_t: np.ndarray, u_t: np.ndarray) -> np.ndarray:
